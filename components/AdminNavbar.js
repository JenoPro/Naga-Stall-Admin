...
const AdminNavbar = ({ activeId }) => {
  ...
  const navItems = [
    { id: 'documents', icon: require('../assets/Documents.png'), label: 'Documents', screen: 'ManageDocument' },
    { id: 'stalls', icon: require('../assets/stalls.png'), label: 'Stalls', screen: 'Stalls' },
    { id: 'users', icon: require('../assets/User.png'), label: 'User', screen: 'ManageUsers' },
    // { id: 'stallholders', icon: require('../assets/stallholders.png'), label: 'Stallholders', screen: 'Stallholders' },
  ];
